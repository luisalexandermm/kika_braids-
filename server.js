...
function initializeDatabase() {
    ...
    db.all("SELECT name FROM services", (err, rows) => {
        ...
        const initialServices = [
            ...
            { name: 'Cornrows', price: 50000, description: 'Trenzas pegadas al cuero cabelludo', image: '', category: 'women', kanekalon: 65000, natural: 60000 },
            { name: 'Trenzas', price: 55000, description: 'Trenzas tradicionales y modernas', image: '', category: 'women', kanekalon: 50000, natural: 40000 },
            ...
            { name: 'extencion medio lado ', price: 40000, description: 'puesta de extencion para mujeres',image: '', category: 'women', },
